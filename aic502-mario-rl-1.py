...
#   3. go down 
#   4. jump-run right 
env = JoypadSpace(env, [["right"], ["right", "A"],  ['A'], ['down'], ['right', 'A', 'B']])
...
class RewardWrapper(gym.Wrapper):
    ...
    def step(self, action):
        ...
        # Add reward for higher x_position to encourage moving forward
        reward += (current_x_position - self.previous_x_position) * 0.1
